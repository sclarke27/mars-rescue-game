...
class SpaceShip extends BaseShip {
    ...
    animate(time) {
        ...
        //     // console.info(this.simulation.objectPositions.x[this.posX+i]);
        //     collidingX = collidingX.concat(this.simulation.objectPositions.x[this.posX+i])
        //     collidingX = collidingX.filter(object => object.type !== this.type);
        // }
        // console.info(collidingX);
    }
